                ...
                <Row>
                  <Col xs={12} md={6}>
                    <CardSubtitle tag="h6" className="mb-2 text-muted">
                      {" "}
                      Ubicacion actual {position.direcction}
                    </CardSubtitle>
                    {currentUbication ? (
                      <p>
                ...
                <Form onSubmit={newLocationFormik.handleSubmit}>
                  ...
                  <ModalBody>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        type="text"
                        invalid={newLocationFormik.errors.nombre ? true : false}
          ...
          >
            <ListGroup>
              {ubications.map((ubication) => (
                ...
                >
                  <CardTitle tag="h5">
                    Dirección: <p>{ubication.direccion}</p>
                  </CardTitle>
                  <CardSubtitle tag="h6" className="mb-2 text-muted">
                    fecha <p>{ubication.date}</p>
                  </CardSubtitle>
