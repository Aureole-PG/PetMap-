                ...
                <Col sm={12} md={6} lg={8}>
                    <form onSubmit={formik.handleSubmit} >
                        <FormGroup>
                            ...
                            <Input type="text" onChange={formik.handleChange} name="nombre" id="PetName" placeholder="ingrese el nombre de su mascota" />
                        </FormGroup>
                        <FormGroup>
                            <Label for="Tipo">Tipo de mascota</Label>
                            <Input type="select" onChange={formik.handleChange} name="tipo" id="Tipo">
                                <option disabled={true} selected={true}>Elige tu mascota</option>
                                <option>Perro</option>
                                <option>Gato</option>
                            </Input>
                        </FormGroup>
                        <FormGroup>
                            ...
                            <Input type="text" onChange={formik.handleChange} name="raza" id="PetRaze" placeholder="ingrese la raza de su mascota" />
                        </FormGroup>
                        <FormGroup>
                            <Label for="GPSID">GPS</Label>
                            <Input type="text" onChange={formik.handleChange} name="gps_id" id="GPSID" placeholder="ingrese el ID del GPS de su mascota" />
                        </FormGroup>
